...
impl Synth {
    ...
    pub fn synth_sample(&mut self) -> Option<f32> {
    ...
    pub fn mutate(&mut self) {
        if self.rng.random::<bool>() {
            self.params.base_freq += self.frnd(0.1) - 0.05;
        }
        if self.rng.random::<bool>() {
            self.params.freq_ramp += self.frnd(0.1) - 0.05;
        }
        if self.rng.random::<bool>() {
            self.params.freq_dramp += self.frnd(0.1) - 0.05;
        }
        if self.rng.random::<bool>() {
            self.params.duty += self.frnd(0.1) - 0.05;
        }
        if self.rng.random::<bool>() {
            self.params.duty_ramp += self.frnd(0.1) - 0.05;
        }
        if self.rng.random::<bool>() {
            self.params.vib_strength += self.frnd(0.1) - 0.05;
        }
        if self.rng.random::<bool>() {
            self.params.vib_speed += self.frnd(0.1) - 0.05;
        }
        if self.rng.random::<bool>() {
            self.params.env_attack += self.frnd(0.1) - 0.05;
        }
        if self.rng.random::<bool>() {
            self.params.env_sustain += self.frnd(0.1) - 0.05;
        }
        if self.rng.random::<bool>() {
            self.params.env_decay += self.frnd(0.1) - 0.05;
        }
        if self.rng.random::<bool>() {
            self.params.env_punch += self.frnd(0.1) - 0.05;
        }
        if self.rng.random::<bool>() {
            self.params.lpf_resonance += self.frnd(0.1) - 0.05;
        }
        if self.rng.random::<bool>() {
            self.params.lpf_freq += self.frnd(0.1) - 0.05;
        }
        if self.rng.random::<bool>() {
            self.params.lpf_ramp += self.frnd(0.1) - 0.05;
        }
        if self.rng.random::<bool>() {
            self.params.hpf_freq += self.frnd(0.1) - 0.05;
        }
        if self.rng.random::<bool>() {
            self.params.hpf_ramp += self.frnd(0.1) - 0.05;
        }
        if self.rng.random::<bool>() {
            self.params.pha_offset += self.frnd(0.1) - 0.05;
        }
        if self.rng.random::<bool>() {
            self.params.pha_ramp += self.frnd(0.1) - 0.05;
        }
        if self.rng.random::<bool>() {
            self.params.repeat_speed += self.frnd(0.1) - 0.05;
        }
        if self.rng.random::<bool>() {
            self.params.arp_speed += self.frnd(0.1) - 0.05;
        }
        if self.rng.random::<bool>() {
            self.params.arp_mod += self.frnd(0.1) - 0.05;
        }
    }
